...
<div class="wrapper">
  ...
  <!-- Navbar -->
  @include('template_penjual.section.header')
  <!-- /.navbar -->

  <!-- Main Sidebar Container -->
  @include('template_penjual.section.sidebar')  
            ...
            <div class="content-wrapper">
              <div class="container">
                <div class="row">
                  ...
                  @include('template_penjual.utils.notif')
                  </div>
  ...
  <!-- Main Footer -->
  @include('template_penjual.section.footer')
</div>
<!-- ./wrapper -->
